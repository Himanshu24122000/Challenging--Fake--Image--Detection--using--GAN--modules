...
<img src="https://github.com/himanshu/mri_gan_deepfake/blob/main/images/mri_model_arch.png" width=35% height=35%>

# MRI-GAN adversarial training

<img src="https://github.com/himanshu/mri_gan_deepfake/blob/main/images/dis_model.png" width=35% height=35%>
<img src="https://github.com/himanshu/mri_gan_deepfake/blob/main/images/gen_model.png" width=55% height=55%>

# MRI-GAN training data formulation

<img src="https://github.com/himanshu/mri_gan_deepfake/blob/main/images/mri_df_dataset_gen.png" width=55% height=55%>

# MRI-GAN sample output on validation set

<img src="https://github.com/himanshu/mri_gan_deepfake/blob/main/images/MRI_demo.png" width=70% height=70%>

# MRI-GAN training progress

<img src="https://github.com/himanshu/mri_gan_deepfake/blob/main/images/L2_loss_plot.png" width=40% height=40% /> <img src="https://github.com/himanshu/mri_gan_deepfake/blob/main/images/loss_G_plot.png" width=40% height=40%/> <img src="https://github.com/himanshu/mri_gan_deepfake/blob/main/images/ssim_loss_plot.png" width=40% height=40%/> <img src="https://github.com/himanshu/mri_gan_deepfake/blob/main/images/ssim_score_plot.png" width=40% height=40%/> <img src="https://github.com/himanshu/mri_gan_deepfake/blob/main/images/loss_D_plot.png" width=40% height=40%/>
...
```
Himanshu Kumar Singh 1DT19CS183 MRI-GAN: A Generalized Approach to Detect DeepFakes using Perceptual Image Assessment. arXiv preprint arXiv:2203.00108 (2023)
```
or
```
@misc{2203.00108,
Author = {Himanshu Kumar Singh[1dt19cs183]},
